...
`windows\scripts\build-installable-package.ps1`. The public installer must wait
until the driver package is Microsoft-signed and clean install/uninstall/upgrade
passes on real Windows test machines.
