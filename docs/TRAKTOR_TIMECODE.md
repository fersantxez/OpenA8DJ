...
OpenA8DJ 0.4.0 is the current macOS public preview. It exposes the Core Audio
surface Traktor needs for output routing and timecode assignment:
...
The 0.4.0 release preserves the 8-input/8-output Traktor-facing channel
