...
8 inputs and 8 outputs. The validated release rates are:
...
Local and CI builds may be ad-hoc signed. Public distribution is possible from
GitHub Releases, but a polished end-user release should use a Developer ID
Installer certificate and Apple notarization so macOS Gatekeeper can verify the
package without extra user steps.
