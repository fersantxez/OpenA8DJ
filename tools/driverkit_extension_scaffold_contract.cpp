...
int main(int argc, char** argv) {
  ...
  const bool runtime_binding_pass = contains_all(driver_cpp, {
      "AudioDriverSkeleton",
      "AudioDeviceRuntimeBinding",
      "start_driver",
      "g_device_binding.configure_device",
      "g_device_binding.start_io(sample_time, host_time)",
      "g_device_binding.stop_io()",
      "g_device_binding.request_configuration_change",
      "g_device_binding.shutdown_driver()",
      "extension_bridge::ConfigureDevice",
      "IOUserAudioDriver::NewUserClient",
  }) && contains_all(device_cpp, {
      "extension_bridge::StartIO(flags)",
      "extension_bridge::StopIO(flags)",
      "extension_bridge::PerformDeviceConfigurationChange(action",
      "extension_bridge::AbortDeviceConfigurationChange(action",
      "IOMemoryDescriptor",
