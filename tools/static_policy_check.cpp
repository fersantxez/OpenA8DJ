...
int main(int argc, char** argv) {
  ...
  const std::vector<std::filesystem::path> audited_files = {
      ...
      root / "tools/driverkit_device_binding_contract.cpp",
      ...
      root / "tools/playback_scheduler_contract.cpp",
      root / "tools/playback_scheduler_runtime_contract.cpp",
      ...
      root / "core/include/opena8djcpp/playback_scheduler.hpp",
      root / "core/src/playback_scheduler.cpp",
      root / "core/include/opena8djcpp/playback_scheduler_runtime.hpp",
      root / "core/src/playback_scheduler_runtime.cpp",
