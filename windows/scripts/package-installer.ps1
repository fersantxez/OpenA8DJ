...
$readmeFirst = @(
    ...
    "3. Secure Boot must be disabled for this test-signed driver.",
    "4. If the installer enables Windows test-signing and asks for a reboot, reboot.",
    "5. Run install.cmd as Administrator again after reboot.",
    "",
