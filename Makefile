...
$(HAL_RUST_BIN): $(HAL_SRC) $(HAL_RUST_PLIST) $(RUST_FFI_LIB) crates/open-a8dj-ffi/include/open_a8dj_rust.h
	...
	xcrun clang $(HAL_CFLAGS) -DOPENA8DJ_RUST_CANDIDATE=1 -DOPENA8DJ_USE_RUST_CORE=1 -I$(RUST_FFI_INCLUDE) -bundle $(HAL_FRAMEWORKS) -o $@ $(HAL_SRC) $(RUST_FFI_LIB)
